...
public class FileUtils {
    ...
    private final String uploadPath = Paths.get("/Users", "kongdaepyo", "Desktop", "upload", today).toString();
     ...
     * @param board_bno - 게시글 번호
     * @return 업로드 파일 목록
     */
    public List<ImageDTO> uploadFiles(MultipartFile[] files, Long board_bno) {
        ...
        for (MultipartFile file : files) {
            try {
                ...
                image.setBoard_bno(board_bno);
                image.setOriginal_name(file.getOriginalFilename());
                image.setSave_name(saveName);
